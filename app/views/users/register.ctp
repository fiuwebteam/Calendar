...
<?php echo $form->create('User', array('action' => 'register'));?>
	...
	<?php	
		...
		echo '<p class="grid_7 supplement box-highlight omega">Must be at least 4 characters, lowercase letters and numbers only.</p>';
	...
	<?php echo $form->submit('Submit',array('tabindex'=>'7', 'div'=>array('class'=>'grid_8 vMarginTop_1'),'class'=>'btn submitBtn'));?>
<?php echo $form->end();?>
</div>
