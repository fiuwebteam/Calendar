...
<hr class="dashed" />
	...
	<?php echo $form->input("Group", array("style" => "width:150px","type" => "select", "options" => array( 2 => "Administrator", 3 => "Editor", 4 => "Author", 5 => "Contributor"),'div'=>array('class'=>'grid_3 formDiv_general vPaddingTop_1 vPaddingBottom_3 vMarginBottom_1')) )?>
