...
?>
	<tr<?php echo $class;?>>
		<td>
			<?php echo $text->truncate($event['Event']['title'], 50, array('ending'=>'...', 'exact'=> false)); ?>
		</td>
		<td>
			<?php echo $text->truncate($event['Event']['description'], 50, array('ending'=>'...', 'exact'=> false)); ?>
		</td>
		<td>
			<?php echo $text->truncate($event['Event']['location'], 50, array('ending'=>'...', 'exact'=> false)); ?>
		</td>
		<td>
			<?php echo $text->truncate($event['Event']['contact'], 50, array('ending'=>'...', 'exact'=> false)); ?>
		</td>
