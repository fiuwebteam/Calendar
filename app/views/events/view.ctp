  ...
  window.fbAsyncInit = function() {
    ...
    function(response) {
	 ...
	 FB.api(
	  	{
	    	method: 'fql.query',
	    	query:'SELECT like_count, share_count, total_count FROM link_stat WHERE "<?php echo $currentHref; ?>" IN url  ORDER BY total_count LIMIT 1;'
	  	},
	  function(r) {
...
FB.Event.subscribe('edge.remove',
 ...
 //update event.fblike whenever page is loaded
  FB.api(
	  	{
	    	method: 'fql.query',
	    	query:'SELECT like_count, share_count, total_count FROM link_stat WHERE "<?php echo $currentHref; ?>" IN url  ORDER BY total_count LIMIT 1;'
