...
<?php echo $form->create('Calendar', array("onsubmit" => "return alertICal()"));?>
	...
	<?php
		...
		echo $form->input('parent_id', array('tabindex'=>'3','div'=>array('class'=>'grid_3   vPaddingTop_1 vPaddingBottom_1 vMarginBottom_1'),'class'=>'', "options" => $calendars));
		
		echo $form->input('private', array('tabindex'=>'4',"type" => "checkbox", 'label'=>array('text'=>'Private','class'=>'grid_1'),'div'=>array('class'=>'grid_3   vPaddingTop_1 vPaddingBottom_1 vMarginBottom_1')));
