...
if ($this->params['action'] == 'edit')
    echo "<script> var editAction = true; </script>";
     
 

$repeatTab = '-1';
if ( $this->data['Event']['repeatTab'] > 0  )
	$repeatTab = $this->data['Event']['repeatTab'];
...
$("#repeatDetails").hide();
    $("#EventRepeatsType1").change(function(){
    	 if( $(this).val()   == 0 ){  
    	 	$("#repeatDetails2").children().hide(); 
    	 	$("#repeatDetails").hide(); 
    	 }
...
<?php echo $form->create('Event', array( "enctype" => "multipart/form-data", "url" => $html->url(null, true), 'id'=>'formElem','name'=>'formElem') );?>
   ...
   <div id="options" style="color: black;">
    ...
    $attributes=array('legend'=>false,'class'=>'occurrences');
   ...
   Repeat Options:    
     ...
     echo $form->select("repeatsType1", array('0'=>'One-time Event','1'=>'Every day','2'=>'Weekly','3'=>'Monthly') ,null, array('class' => ""), false); ?>
	   ...
	   $weekdays = array("Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday");
	      for($y = 0; $y <= 6; $y++) {
			echo $form->input(($weekdays[$y] . "_1" ), array("type" => "hidden", "name" => "data[Event][{$weekdays[$y]}][1]", "id"=>"weekly-".$weekdays[$y], 'default'=>'1' ));
			 		}
			 		
	?>
	
	
	<div id ="repeatDetails" class="grid_2 alpha omega">for  <?php echo $form->select("dateParameter_2_1", $numbers ,null, array('class' => "","style"=>"width:50px;"), false); ?> <div>
   ...
   <div id="inputTopSection" class="grid_11 vMarginTop_1">
	...
	<?php 
 	...
 	<div class="ef_label">Start Time:</div>
 ...
 <div id="endItems" style="overflow:auto;margin-top:5px;">	
	 	...
	 	<div class="ef_label">End Date:</div>	
		...
		<div class="grid_3 alpha omega" id ="no-end-time" style="display:none">NO END TIME</div>
	 	...
	 	<div class="ef_label">End Time:</div>
...
Need to edit an image but don't have photoshop? Use <a target=_"blank" href="http://www.picnik.com/">Picnik</a></span>	
 	<div class='clear'></div>
...
<div style="float:left;margin-left:60px;">Must be less than 69px X 69px</div>
 ...
 <?php echo $form->input('repeatTab',array('type'=>'hidden', 'id'=>'repeatTab', 'default'=>'-1'));?>
