...
<?php
    ...
    ?>
<meta property="og:description" content="<?php echo ($event['Event']['description']); ?>"/>

    <meta property="og:site_name" content="calendar.fiu.edu" />
...
<?php 		
	...
	//echo $javascript->link('xof1kob');
	echo $javascript->link('timepicker'); 
	
	//echo $javascript->link('all.min');
	//echo $scripts_for_layout;
?>
<script type="text/javascript" src="http://w.sharethis.com/button/buttons.js"></script>
<script type="text/javascript">stLight.options({publisher:'452986fe-ae1f-4747-ad23-4d9643e5c8b6'});</script>	
